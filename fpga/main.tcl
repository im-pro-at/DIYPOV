# 
# Project automation script for main 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source main.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "apa102.vhd"
   xfile add "apa102group.vhd"
   xfile add "cordic_tb.vhd"
   xfile add "ipcore_dir/cordic.xco"
   xfile add "ipcore_dir/div.xco"
   xfile add "ipcore_dir/frameDPRAM.xco"
   xfile add "ipcore_dir/pll.xco"
   xfile add "ledgroup.vhd"
   xfile add "ledgroup_tb.vhd"
   xfile add "main.ucf"
   xfile add "main.vhd"
   xfile add "main_tb.vhd"
   xfile add "sendfifo.vhd"
   xfile add "sendfifo_tb.vhd"
   xfile add "settled.vhd"
   xfile add "settled_tb.vhd"
   xfile add "synchronise.vhd"
   xfile add "synchronise_tb.vhd"
   puts ""
...
proc set_process_props {} {
   ...
   project set "Target UCF File Name" "D:/Drive/Dokumente/Projekte/POV/fpga/main.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Work Directory" "D:/Drive/Dokumente/Projekte/POV/fpga/xst" -process "Synthesize - XST"
